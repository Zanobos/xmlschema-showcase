...
@Generated(value = {
    "wadl|http://localhost:9008/Neo4JXML/rest/application.wadl"
}, comments = "wadl2java, http://wadl.java.net", date = "2017-02-22T15:43:45.911+01:00")
public class Localhost_Neo4JXMLRest {
    ...
    static {
        URI originalURI = URI.create("http://localhost:9008/Neo4JXML/rest/");
